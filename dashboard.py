...
rec_df = pd.read_csv(r'E:\University\VI BigData\kafka\tutorial12\Spotify-Recommendation-System-using-Pyspark-and-Kafka-main\rec_song.csv')
# E:\University\VI BigData\kafka\tutorial12\Spotify-Recommendation-System-using-Pyspark-and-Kafka-main\rec_song.csv
...
fig = px.pie(df1, values=df['artists'].value_counts()[:11], names='Name', hole=0.2)
